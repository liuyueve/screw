...
import cn.smallbun.screw.core.PojoConfiguration;
import cn.smallbun.screw.core.Configuration;
import cn.smallbun.screw.core.strategy.NameStrategy;
import cn.smallbun.screw.core.metadata.model.ColumnModel;
import cn.smallbun.screw.core.metadata.model.PojoModel;
import cn.smallbun.screw.core.metadata.model.TableModel;
import cn.smallbun.screw.core.metadata.model.TypeModel;
import cn.smallbun.screw.core.query.TypeDialectFactory;
import cn.smallbun.screw.core.query.TypeDialect;
 ...
 */
public class PojoModelProcess extends AbstractProcess<List<PojoModel>> {
    ...
    public PojoModelProcess(PojoConfiguration configuration) {
        super(configuration.getProcessConfig());
        this.pojoConfiguration = configuration;
    }

    @Override
    public List<PojoModel> process() throws Exception {
        //获取数据库元数据
        List<TableModel> tableModels = getTableModel(pojoConfiguration.getDataSource());
