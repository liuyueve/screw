...
import cn.smallbun.screw.core.engine.freemark.FreeMarkerPojoEngine;
import cn.smallbun.screw.core.exception.ScrewException;
import cn.smallbun.screw.core.metadata.model.PojoModel;
import cn.smallbun.screw.core.process.PojoModelProcess;
...
public class PojoExecute implements Execute {
    ...
    public void execute() {
        try {
            ...
            //获取数据
            List<PojoModel> process = new PojoModelProcess(configuration).process();
            //新建模板引擎
